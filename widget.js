function twitter_widget() {
    Function && Function.prototype && Function.prototype.bind && (/MSIE [678]/.test(navigator.userAgent) || (window.__twttr && window.__twttr.widgets && window.__twttr.widgets.loaded && window.twttr.widgets.load && window.twttr.widgets.load(), window.__twttr && window.__twttr.widgets && window.__twttr.widgets.init || ! function(t) {
        ...
        return e.e = function(t, e) {}, e.e = function(t, n) {
            ...
            if (void 0 !== i[t]) i[t].push(n);
                ...
                o.type = "text/javascript", o.charset = "utf-8", o.async = !0, o.onerror = function() {
                    ...
                    1: "71000885400e222c3c0eec823f8f93f0",
                    2: "615d582e9602ee6a545f6f50286969b3",
                    3: "3013da4e23de5832e6e40ecf4980be28",
                    4: "e158f34e73111f999d67f75e522e0576",
                    5: "0eae788bc4fdbe9cd3e72dca3bc26358",
                    6: "00c2bb81d4f3f312a9a021c715a1c9dc"
        ...
        var r, i = n(1),
            ...
            v = n(228),
            g = "_e";
        s.set("widgets.init", !0), u.set("init", !0), v(), r = new i, a.exposeReadyPromise(r.promise, u.base, g), u.set("widgets", h), u.set("widgets.load", l.load), u.set("events", d), s.init("host", "platform.twitter.com"), m(function() {
        ...
        (function(t) {
            ...
            (function() {
                ...
                function E(t, e) {
                    e._state === rt ? I(t, e._result) : e._state === it ? N(t, e._result) : S(e, void 0, function(e) {
                        A(t, e)
                    }, function(e) {
                        N(t, e)
                    })
                ...
                function I(t, e) {
                    t._state === nt && (t._result = e, t._state = rt, 0 !== t._subscribers.length && J(C, t))
                }
                ...
                function S(t, e, n, r) {
                    var i = t._subscribers,
                        o = i.length;
                    t._onerror = null, i[o] = e, i[o + rt] = n, i[o + it] = r, 0 === o && t._state && J(C, t)
                }
                ...
                function j(t, e, n, r) {
                    var i, a, s, u, c = o(n);
                    if (c) {
                        if (i = R(n, r), i === at ? (u = !0, a = i.error, i = null) : s = !0, e === i) return void N(e, w())
                    } else i = r, s = !0;
                ...
                function D(t) {
                    ...
                    for (var o = t.length, a = 0; i._state === nt && o > a; a++) S(r.resolve(t[a]), void 0, e, n);
                    return i
                }
                ...
                function B(t) {
                    this._id = lt++, this._state = void 0, this._result = void 0, this._subscribers = [], v !== t && (o(t) || U(), this instanceof B || M(), k(this, t))
                }
                ...
                O.prototype._enumerate = function() {
                    ...
                    var r = this,
                        i = r.promise;
                    i._state === nt && (r._remaining--, t === it ? N(i, n) : r._result[e] = n), 0 === r._remaining && I(i, r._result)
                ...
                var ut = L,
                    ...
                    lt = 0,
                    ht = B;
                B.all = ut, B.race = ct, B.resolve = ft, B.reject = dt, B._setScheduler = s, B._setAsap = u, B._asap = J, B.prototype = {
                    constructor: B,
                    then: function(t, e) {
                        var n = this,
                            r = n._state;
        ...
        E.set("verifyCSP", function(t) {
            ...
            var t;
            return y.asBoolean(_.val("widgets:csp")) ? A = !0 : (t = p.createElement("script"), t.id = I, t.text = E.fullPath("verifyCSP") + "(false);", p.body.appendChild(t), void v.setTimeout(function() {
        ...
        function r(t) {
            return "string" == typeof t && y.test(t) && RegExp.$1.length <= 20
        }
        ...
        function o(t, e) {
            var n = w.decodeURL(t);
            return e = e || !1, n.screen_name = i(t), n.screen_name ? w.url("https://twitter.com/intent/" + (e ? "follow" : "user"), n) : void 0
        }
        ...
        var w = n(28),
            y = /(?:^|(?:https?\:)?\/\/(?:www\.)?twitter\.com(?:\:\d+)?(?:\/intent\/(?:follow|user)\/?\?screen_name=|(?:\/#!)?\/))@?([\w]+)(?:\?|&|$)/i,
            b = /(?:^|(?:https?\:)?\/\/(?:www\.)?twitter\.com(?:\:\d+)?\/(?:#!\/)?[\w_]+\/status(?:es)?\/)(\d+)/i,
            _ = /^http(s?):\/\/(\w+\.)*twitter\.com([\:\/]|$)/i,
            E = /^http(s?):\/\/pbs\.twimg\.com\//,
            x = /^#?([^.,<>!\s\/#\-\(\)\'\"]+)$/,
            A = /twitter\.com(?:\:\d{2,4})?\/intent\/(\w+)/,
            T = /^https?:\/\/(?:www\.)?twitter\.com\/\w+\/timelines\/(\d+)/i,
        ...
        var d = n(9),
            ...
            w = "https://syndication.twitter.com/i/jot/syndication",
            y = "https://platform.twitter.com/jot.html",
            b = 1;
        t.exports = {
        ...
        function r() {
            ...
            return T ? I.promise : (l = new b, l.insert("rufous-sandbox", null, {
                display: "none"
            }, t).then(function() {
        ...
        function u() {
            ...
            return A++, t.action = w.CLIENT_EVENT_ENDPOINT, t.method = "POST", t.target = E + A, t.id = x + A, e.type = "hidden", e.name = "dnt", e.value = m.enabled(), n.type = "hidden", n.name = "tfw_redirect", n.value = w.RUFOUS_REDIRECT, t.appendChild(e), t.appendChild(n), t
        }
        ...
        function a(t) {
            t.overrideProperty("id", {
                ...
                return f.write(_(a, null, c)), c.addEventListener("load", function() {
                    ...
                    return s._iframe = t, s.win.addEventListener("resize", e, !1), g.all([s.setTargetToBlank(), s.addRootClass(T), s.prependCss(I)])
                })
        ...
        t.exports = [n(71), n(102), n(144), n(150), n(156), n(193), n(206), n(211)]
    }, function(t, e, n) {
        function r(t) {
            var e = s(t),
                n = {
        ...
        t.exports = {
            css: "f7130f11be9c2719286897ede16853b9"
        }
    }, , function(t, e, n) {
        function r() {
            return f + d++
        ...
        function r(t) {
            t.params({
                ...
                t.getAttribute(d) || (t.setAttribute(d, !0), t.href = u.url(t.href, {
                    tw_w: this.params.dataSource && this.params.dataSource.dataSourceIdentifier(),
        ...
        function r(t) {
            ...
            return r = a.aug(r, a.compact(e)), f(r), r
        }
        ...
        var r = n(186),
            i = [n(187), n(189), n(190), n(191), n(192)];
        t.exports = function(t) {
            var e = r(i, function(e) {
                return e.canProcessOptions(t)
            });
            t.dataSource = e && new e(t)
        }
    }, function(t, e) {
        t.exports = function(t, e, n) {
            for (var r, i = 0; i < t.length; i++)
                if (r = t[i], e.call(n, r, i, t)) return r
        }
    }, function(t, e, n) {
        function r(t) {
            t.params({
                ...
                customTimelineId: {},
                previewParams: {}
            }), t.defineStatic("canProcessOptions", function(t) {
                return !!t.widgetId
            }), t.override("endpoint", function() {
                return c + this.params.widgetId
            }), t.override("pollEndpoint", function() {
                return d + this.params.widgetId
            ...
            }), t.override("dataSourceIdentifier", function() {
                return this.params.widgetId
            }), t.override("isLegacy", function() {
                return !0
            })
        }
        var i = n(188),
            ...
            a = n(17),
            s = n(15),
            u = a.get("backendHost") || "https://syndication.twitter.com",
            c = u + "/widgets/timelines/",
            f = a.get("backendHost") || "https://syndication.twitter.com",
            d = f + "/widgets/timelines/paged/";
        t.exports = o.build([i, r])
    }, function(t, e, n) {
        function r(t) {
            t.params({
                instanceId: {
                    required: !0,
                    fallback: c.deterministic
                },
                lang: {
                    required: !0,
                ...
                return s.fetch(this.endpoint(), t, u, this.cbId()).then(i, o)
            }), t.define("poll", function(t) {
                t = t || {};
                ...
                return s.fetch(this.pollEndpoint(), r, u, this.cbId(e)).then(i, o)
            }), t.define("standardParams", function() {
                return {
            ...
            }), t.define("endpoint", a), t.define("pollEndpoint", function() {
                return this.endpoint()
            }), t.define("queryParams", a), t.define("dataSourceIdentifier", a), t.define("cbId", function(t) {
                var e = t ? "_" + t : "";
                return "tl_" + this.params.instanceId + "_" + this.dataSourceIdentifier() + e
            }), t.define("isLegacy", function() {
                return !1
            }), t.define("isPreview", function() {
                return !1
            })
        }
        ...
        function i(t) {
            t.params({
                ...
                return !!r(t.url, t.customTimelineId)
            }), t.override("endpoint", function() {
                return f + "collection"
            }), t.override("queryParams", function() {
                return {
                    collection_id: this.dataSourceIdentifier()
                }
            }), t.override("dataSourceIdentifier", function() {
        ...
        var o = n(188),
            ...
            s = n(17),
            u = n(27),
            c = s.get("backendHost") || "https://syndication.twitter.com",
            f = c + "/timeline/";
        t.exports = a.build([o, i])
    }, function(t, e, n) {
        function r(t, e) {
            return u.screenName(t) || e
        }
        ...
        function i(t) {
            t.params({
                ...
                return !!r(t.url, t.profileScreenName) || !!t.profileUserId
            }), t.override("endpoint", function() {
                return f + "profile"
            }), t.override("queryParams", function() {
                var t = r(this.params.url, this.params.profileScreenName);
                return t ? {
                    screen_name: t
                } : {
                    user_id: this.params.profileUserId
                }
            }), t.override("dataSourceIdentifier", function() {
                var t = r(this.params.url, this.params.profileScreenName);
                return t || this.params.profileUserId
            })
        }
        var o = n(188),
            a = n(56),
        ...
        function r(t) {
            return c.likesScreenName(t.url) || t.likesScreenName || t.favoritesScreenName
        }

        function i(t) {
            return t.likesUserId || t.favoritesUserId
        }
        ...
        function o(t) {
            t.params({
                ...
                return t ? {
                    ...
                    user_id: i(this.params)
                }
            }), t.override("dataSourceIdentifier", function() {
                return r(this.params) || i(this.params)
            })
        }
        var a = n(188),
            s = n(56),
            u = n(17),
            c = n(27),
            f = u.get("backendHost") || "https://syndication.twitter.com",
            d = f + "/timeline/";
        t.exports = s.build([a, o])
    }, function(t, e, n) {
        function r(t) {
            var e = u(t),
        ...
        var r = n(14);
        t.exports = r.aug({}, n(219), n(221), n(222), n(223), n(224), n(225), n(226), n(227))
    }, function(t, e, n) {
        var r = n(77),
            i = n(220),
            o = i(["screenName"], {}, r);
        ...
        function r() {
            ...
            return u.isString(n[0]) && (e = n[0], n = n.slice(1)), n.forEach(function(e) {
                s.isType("object", e) && (t = e, i(t))
            }), t || (t = {}, n.push(t)), t.widgetId = e, d(t), l.apply(this, n)
        }
